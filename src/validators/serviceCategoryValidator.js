...
const { isValidString, isValidInteger, isValidBoolean, isValidEnum } = require('../utils/validators');
...
const validateServiceCategory = [
  ...
  body('vehicleType')
    .optional()
    .isIn(['CAR', 'BIKE', 'SCOOTER', 'TRUCK'])
    .withMessage('Vehicle type must be one of: CAR, BIKE, SCOOTER, TRUCK'),
